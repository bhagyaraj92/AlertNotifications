...
const AlertNotifications = () => {
  const renderSuccessNotification = () => (
    <Notification>
      ...
      <div className="message-container">
        <h1 className="mes-heading success">Success</h1>
  ...
  const renderErrorNotification = () => (
    <Notification>
      ...
      <div className="message-container">
        <h1 className="mes-heading error">Error</h1>
        <p className="para">
  ...
  const renderWarningNotification = () => (
    <Notification>
      ...
      <div className="message-container">
        <h1 className="mes-heading warning">Warning</h1>
        <p className="para">
  ...
  const renderInfoNotification = () => (
    <Notification>
      ...
      <div className="message-container">
        <h1 className="mes-heading info">Info</h1>
